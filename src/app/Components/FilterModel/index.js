...
import { Autocomplete, Box, Button, FormControl, Modal, Stack, TextField } from '@mui/material';
...
const FilterModel = ({ label, iconSx }) => {
    ...
    return (
        <>
            <FilterListIcon onClick={handleOpen} fontSize="small" sx={iconSx} />
