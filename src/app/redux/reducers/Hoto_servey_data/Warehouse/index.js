...
export const hotoWarehouseAssetPortfolioMaintenanceDataReducer = (
  ...
  switch (action.type) {
    case HOTO_WAREHOUSE_ASSET_PORTFOLIO_MAINTENANCE_DATA_REQUEST:
      return {
        ...state,
        loading: true,
      };
    case HOTO_WAREHOUSE_ASSET_PORTFOLIO_MAINTENANCE_DATA_SUCCESS:
      return {
        ...state,
        data: action.payload.data,
        loading: false,
      };
    case HOTO_WAREHOUSE_ASSET_PORTFOLIO_MAINTENANCE_DATA_FAILED:
      return {
        data: {},
        error: true,
        errorMessage: action.payload,
...
export const hotoWarehouseAssetPortfolioReplacementDataReducer = (
  ...
  switch (action.type) {
    case HOTO_WAREHOUSE_ASSET_PORTFOLIO_REPLACEMENT_DATA_REQUEST:
      return {
        ...state,
        loading: true,
      };
    case HOTO_WAREHOUSE_ASSET_PORTFOLIO_REPLACEMENT_DATA_SUCCESS:
      return {
        ...state,
        data: action.payload.data,
        loading: false,
      };
    case HOTO_WAREHOUSE_ASSET_PORTFOLIO_REPLACEMENT_DATA_FAILED:
      return {
        data: {},
        error: true,
        errorMessage: action.payload,
...
export const hotoWarehouseAssetPortfolioTransferDataReducer = (
  ...
  switch (action.type) {
    case HOTO_WAREHOUSE_ASSET_PORTFOLIO_TRANSFER_DATA_REQUEST:
      return {
        ...state,
        loading: true,
      };
    case HOTO_WAREHOUSE_ASSET_PORTFOLIO_TRANSFER_DATA_SUCCESS:
      return {
        ...state,
        data: action.payload.data,
        loading: false,
      };
    case HOTO_WAREHOUSE_ASSET_PORTFOLIO_TRANSFER_DATA_FAILED:
      return {
        data: {},
        error: true,
        errorMessage: action.payload,
