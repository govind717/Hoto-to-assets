...
const damagedData = [
  { name: "Replaced", value: 1870, color: "#22CAAD" },
  { name: "Pending", value: 700, color: "#FDCF2A" },
];

const DamagedChart = () => {
  const total = damagedData.reduce((sum, item) => sum + item.value, 0);
  const enhancedData = [
