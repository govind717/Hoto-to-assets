            ...
            <TableRow sx={{ bgcolor: "#53B8CA" }}>
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <FilterModel
                    ...
                    apiUrl={`/hoto-to-assets/block/transfer/filter-dropdown?filter_field=transfer_id&package_name=${packageNoDataReducer?.data}`}
                  />
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <FilterModel
                    ...
                    setApplyFilter={setApplyFilter}
                    package_name={packageNoDataReducer?.data}
                    apiUrl={`/hoto-to-assets/block/transfer/filter-dropdown?filter_field=createdAt&package_name=${packageNoDataReducer?.data}`}
                  />
                </Box>
              </TableCell>
              <TableCell align={"left"} sx={{ ...tableCellSx }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <FilterModel
                    ...
                    setApplyFilter={setApplyFilter}
                    package_name={packageNoDataReducer?.data}
                    apiUrl={`/hoto-to-assets/block/transfer/filter-dropdown?filter_field=assets_details.equipment_name&package_name=${packageNoDataReducer?.data}`}
                  />
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <FilterModel
                    ...
                    setApplyFilter={setApplyFilter}
                    package_name={packageNoDataReducer?.data}
                    apiUrl={`/hoto-to-assets/block/transfer/filter-dropdown?filter_field=assets_details.serial_no&package_name=${packageNoDataReducer?.data}`}
                  />
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <FilterModel
                    ...
                    setApplyFilter={setApplyFilter}
                    package_name={packageNoDataReducer?.data}
                    apiUrl={`/hoto-to-assets/block/transfer/filter-dropdown?filter_field=transfer_type&package_name=${packageNoDataReducer?.data}`}
                  />
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <FilterModel
                    ...
                    setApplyFilter={setApplyFilter}
                    package_name={packageNoDataReducer?.data}
                    apiUrl={`/hoto-to-assets/block/transfer/filter-dropdown?filter_field=transfer_from.location_name&package_name=${packageNoDataReducer?.data}`}
                  />
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <FilterModel
                    ...
                    setApplyFilter={setApplyFilter}
                    package_name={packageNoDataReducer?.data}
                    apiUrl={`/hoto-to-assets/block/transfer/filter-dropdown?filter_field=transfer_to.location_name&package_name=${packageNoDataReducer?.data}`}
                  />
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <FilterModel
                    label="Filter Incharge"
                    field="incharge"
                    filters={filters}
                    setFilters={setFilters}
                    setApplyFilter={setApplyFilter}
                    package_name={packageNoDataReducer?.data}
                    apiUrl={`/hoto-to-assets/block/transfer/filter-dropdown?filter_field=incharge&package_name=${packageNoDataReducer?.data}`}
                  />
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <FilterModel
                    ...
                    setApplyFilter={setApplyFilter}
                    package_name={packageNoDataReducer?.data}
                    apiUrl={`/hoto-to-assets/block/transfer/filter-dropdown?filter_field=transfer_status&package_name=${packageNoDataReducer?.data}`}
                  />
                </Box>
              </TableCell>
              <TableCell align={"left"} sx={{ ...tableCellSx }}>
