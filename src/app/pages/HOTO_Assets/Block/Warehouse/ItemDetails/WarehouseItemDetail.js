...
const AssetsPortFolioItemDetail = () => {
    ...
    <>
      ...
      <Box sx={{ width: "100%", typography: "body1", mt: 1 }}>
        <TabContext value={value}>
          ...
          <TabPanel value="1" sx={{ p: 0 }}><TranferTable /></TabPanel>
          <TabPanel value="2" sx={{ p: 0 }}><MaintenanceTable /></TabPanel>
        </TabContext>
      </Box>
    </>
  );
};
export default AssetsPortFolioItemDetail;
