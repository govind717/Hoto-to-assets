...
import { oandm_materialrequest_requestlog_data_disptach } from "app/redux/actions/O&MWarehouse/MaterialRequest";
...
const RequestLogList = () => {
  ...
  const handleSearch = (searchTerm) => {
    setPage(1);
    dispatch(
      oandm_materialrequest_requestlog_data_disptach({
        sortBy: sortBy,
