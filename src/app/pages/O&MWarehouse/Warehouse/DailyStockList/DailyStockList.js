...
import { oandm_warehouse_dailystock_data_disptach } from "app/redux/actions/O&MWarehouse/Warehouse";
...
const DailyStockList = () => {
  ...
  const { oandmWarehouseDailyStockDataReducer } = useSelector((state) => state);
  ...
  const handleSearch = (searchTerm) => {
    setPage(1);
    dispatch(
      oandm_warehouse_dailystock_data_disptach({
        sortBy: sortBy,
  ...
  return (
    <>
      {oandmWarehouseDailyStockDataReducer?.loading && <FullScreenLoader />}
