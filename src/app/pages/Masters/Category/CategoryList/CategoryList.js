...
const CategoryList = () => {
  ...
  return (
    <>
      {categoryDataReducer?.loading && <FullScreenLoader />}
      ...
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 650 }} size="small">
              ...
              <TableCell align={"left"} sx={{ ...tableCellSx }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                  ...
                  <FilterModel
                    ...
                    apiUrl={`/master/category/filter-dropdown?filter_field=category`}
                  />
                </Box>
              </TableCell>
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                  ...
                  <FilterModel
                    ...
                    setApplyFilter={setApplyFilter}
                    package_name={packageNoDataReducer?.data}
                    apiUrl={`/master/category/filter-dropdown?filter_field=created_user_details.firstName`}
                  />
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                  ...
                  <FilterModel
                    ...
                    setApplyFilter={setApplyFilter}
                    package_name={packageNoDataReducer?.data}
                    apiUrl={`/master/category/filter-dropdown?filter_field=updated_user_details.firstName`}
                  />
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                  ...
                  <FilterModel
                    ...
                    setApplyFilter={setApplyFilter}
                    package_name={packageNoDataReducer?.data}
                    apiUrl={`/master/category/filter-dropdown?filter_field=status`}
                  />
                </Box>
              </TableCell>
              <TableCell
          ...
          <TableBody>
            {categoryDataReducer?.data?.result?.data.length > 0 ? (
              categoryDataReducer?.data?.result?.data.map((ele, index) => {
                return (
                  <TableRow key={ele?.id}>
                    <TableCell
                      align="left"
