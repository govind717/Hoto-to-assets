...
const OrganizationList = () => {
  ...
  return (
    <>
      {organisationDataReducer?.loading && <FullScreenLoader />}
      ...
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 650 }} size="small">
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                  ...
                  <FilterModel
                    ...
                    setFilters={setFilters}
                    setApplyFilter={setApplyFilter}
                    apiUrl={`/master/organisation/filter-dropdown?filter_field=created_user_details.firstName`}
                  />
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                  ...
                  <FilterModel
                    ...
                    setFilters={setFilters}
                    setApplyFilter={setApplyFilter}
                    apiUrl={`/master/organisation/filter-dropdown?filter_field=updated_user_details.firstName`}
                  />
                </Box>
              </TableCell>
          ...
          <TableBody>
            {organisationDataReducer?.data?.result?.data.length > 0 ? (
              organisationDataReducer?.data?.result?.data.map((ele, index) => {
                return (
                  <TableRow key={ele?.id}>
                    <TableCell
                      align="left"
