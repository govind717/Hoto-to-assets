                        ...
                        <TableCell align={"left"} sx={{ ...tableCellSx }}>
                            ...
                            <TableCell align={"left"} sx={{ ...tableCellSx, minWidth: "220px" }}>
                                <TableSortLabel
                                    ...
                                    direction={sort}
                                    sx={{ ...tableCellSort }}
                                >Replacement Date</TableSortLabel>
                            </TableCell>
                            <TableCell align={"left"} sx={{ ...tableCellSx, minWidth: "220px" }}>
                                <TableSortLabel
                                    ...
                                    direction={sort}
                                    sx={{ ...tableCellSort }}
                                >Replacement Reason</TableSortLabel>
                            </TableCell>
                            ...
                            <TableCell align={"left"} sx={{ ...tableCellSx, minWidth: "220px" }}>
                                <TableSortLabel
                                    ...
                                    direction={sort}
                                    sx={{ ...tableCellSort }}
                                >Replacement Status</TableSortLabel>
                            </TableCell>
                            <TableCell align={"left"} sx={{ ...tableCellSx }}>
                                Remark
                            </TableCell>
